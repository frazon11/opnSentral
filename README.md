...
4. Use **Presentation Mode** when preparing screenshots or demonstrations containing customer/firewall information.
5. Configure notifications if email alerts are required.
