...
<div class="alert warningbox"><strong>User writes require an online current agent.</strong> Editable fields include Disabled, Login shell, Group membership, direct Privileges and Authorized Keys. Password hashes, OTP seeds and API keys are preserved.</div>
