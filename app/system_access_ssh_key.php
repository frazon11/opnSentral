...
$capable = $online && $version !== '' && version_compare($version, '0.1.14', '>=');
...
<div class="card ssh-key-card">
    ...
    <?php if (!$capable): ?>
        <div class="alert warningbox"><strong>Cannot deploy yet.</strong> This firewall needs an online agent 0.1.14.</div>
    <?php else: ?>
