...
function advanced_agent_writable(?array $agent): bool
{
...
$settings = [
    ...
    'Bogon Networks' => ['bogons_interval'=>['label'=>'Update Frequency','type'=>'text','help'=>'daily, weekly or monthly']],
    'Gateway Monitoring' => ['skip_rules_gw_down'=>['label'=>'Skip rules','type'=>'boolean','help'=>'Skip rules when gateway is down.']],
    'Multi-WAN' => [
    ...
    'Schedules' => ['schedule_states'=>['label'=>'Schedule States','type'=>'boolean']],
    'Logging' => [
    ...
    'Miscellaneous' => [
        ...
        'disablefilter'=>['label'=>'Disable Firewall','type'=>'boolean','help'=>'Disables packet filtering. Use with care.'],
    ...
    'Anti DDOS' => [
        'syncookies'=>['label'=>'Enable syncookies','type'=>'text','help'=>'never, always or adaptive'],
...
foreach($firewalls as $firewall){
    ...
    try{
        ...
        $entry['values']=[
            ...
            'bogons_interval'=>strtolower(advanced_matrix_value($xml,'/opnsense/system/bogons/interval','monthly')),
            ...
            'syncookies'=>advanced_matrix_value($xml,'/opnsense/system/syncookies','never'),
...
<div id="fleet-settings-root" data-fleet-settings-scope="advanced" data-csrf="<?=h(csrf_token())?>">
<div class="fleet-settings-table-wrap"><table class="fleet-settings-table"><thead><tr><th class="setting-col">Setting</th><th class="all-col">All</th><?php foreach($matrix as $fid=>$entry):$writable=$entry['ok']&&advanced_agent_writable($entry['agent']);?><th class="firewall-col"><a href="/firewall_view.php?id=<?=$fid?>"><?=h((string)$entry['firewall']['name'])?></a><?php if(!$entry['ok']):?><small><span class="badge bad">Read failed</span></small><?php elseif($writable):?><small><span class="badge good">Agent ready</span></small><?php elseif(is_array($entry['agent'])):?><small><span class="badge warning">Agent 0.1.6+ required</span></small><?php else:?><small><span class="badge neutral">Agent required</span></small><?php endif;?></th><?php endforeach;?></tr></thead><tbody>
