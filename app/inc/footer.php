...
<link rel="stylesheet" href="/assets/topbar-controls.css?v=06203">
<link rel="stylesheet" href="/assets/sidebar-opnsense.css?v=06203">
<link rel="stylesheet" href="/assets/sidebar-submenus.css?v=06203">
<link rel="stylesheet" href="/assets/ids-bulk-actions.css?v=06203">
<script src="/assets/ids-menu.js?v=06203"></script>
<script src="/assets/sidebar-opnsense.js?v=06203"></script>
<script src="/assets/ids-write-label.js?v=06203"></script>
<script src="/assets/ids-bulk-actions.js?v=06203"></script>
<script src="/assets/ids-ruleset-filter.js?v=06203"></script>
<script src="/assets/ids-policy-editor.js?v=06203"></script>
<script src="/assets/shared-inventory-management.js?v=06203"></script>
<script src="/assets/category-edit-links.js?v=06203"></script>
<script>
(function(){
    document.title = 'opnSentral';
    const version = document.querySelector('.sidebar-meta span:first-child');
    if(version) version.textContent = 'v0.6.20.3';
